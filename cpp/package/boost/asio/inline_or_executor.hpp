...
#ifndef BOOST_ASIO_INLINE_OR_EXECUTOR_HPP
#define BOOST_ASIO_INLINE_OR_EXECUTOR_HPP
...
public:
   ...
   *
   * For example:
   * @code boost::asio::inline_or_executor<my_executor_type> ex1 = ...;
   * auto ex2 = boost::asio::require(ex1,
    ...
    noexcept(is_nothrow_require<const Executor&, Property>::value)
  {
    return inline_or_executor<
        ...
        Blocking, InlineExceptionHandling>(boost::asio::require(executor_, p));
  }
...
private:
  ...
  {
    boost::asio::require(executor_, execution::blocking.never).execute(
...
/** @defgroup inline_or boost::asio::inline_or
 *
 * @brief The boost::asio::inline_or function creates an @ref inline_or_executor
...
#endif // BOOST_ASIO_INLINE_OR_EXECUTOR_HPP
