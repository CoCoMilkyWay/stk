...
#define LEVEL_1_FIELDS(X)\
  ...
  X(arr_bid,            1, DATA,  TS,   ORDER_FLOW, RAW,        NONE,        "00/100/00", "Bid Order Arrival Rate",           "买单到达率",            "单位时间买单到达量(降频)",                             R"(\frac{|O_{\Delta t}^{M,B}|}{\Delta t})")\
  X(arr_ask,            1, DATA,  TS,   ORDER_FLOW, RAW,        NONE,        "00/100/00", "Ask Order Arrival Rate",           "卖单到达率",            "单位时间卖单到达量(降频)",                             R"(\frac{|O_{\Delta t}^{M,A}|}{\Delta t})")\
  X(can_bid,            1, DATA,  TS,   ORDER_FLOW, RAW,        NONE,        "00/100/00", "Bid Cancellation Rate",            "买单撤单率",            "单位时间买单撤销量(降频)",                             R"(\frac{|O_{\Delta t}^{C,B}|}{\Delta t})")\
  X(can_ask,            1, DATA,  TS,   ORDER_FLOW, RAW,        NONE,        "00/100/00", "Ask Cancellation Rate",            "卖单撤单率",            "单位时间卖单撤销量(降频)",                             R"(\frac{|O_{\Delta t}^{C,A}|}{\Delta t})")\
  X(trd_buy,            1, DATA,  TS,   ORDER_FLOW, RAW,        NONE,        "00/100/00", "Active Buy Trade Rate",            "主动买成交率",          "单位时间主动买成交量(降频)",                           R"(\frac{|O_{\Delta t}^{T,B}|}{\Delta t})")\
  X(trd_sell,           1, DATA,  TS,   ORDER_FLOW, RAW,        NONE,        "00/100/00", "Active Sell Trade Rate",           "主动卖成交率",          "单位时间主动卖成交量(降频)",                           R"(\frac{|O_{\Delta t}^{T,A}|}{\Delta t})")\
  X(net_ord,            1, DATA,  TS,   ORDER_FLOW, RAW,        NONE,        "00/100/00", "Net Order Flow",                   "净订单流",              "买卖订单流量净差(降频)",                               R"((|O_{\Delta t}^{M,B}| - |O_{\Delta t}^{C,B}|) - (|O_{\Delta t}^{M,A}| - |O_{\Delta t}^{C,A}|))")\
  X(foi,                1, DATA,  TS,   ORDER_FLOW, RATIO,      NONE,        "00/100/00", "Flow Imbalance",                   "订单流失衡",            "买卖订单量流失衡(降频)",                               R"(\frac{\Delta V_t^{B} - \Delta V_t^{A}}{|\Delta V_t^{B}| + |\Delta V_t^{A}|}, \quad \Delta V_t^{s} = |O_t^{T,s}| - |O_t^{C,s}|, \quad s \in \{B,A\})")\
