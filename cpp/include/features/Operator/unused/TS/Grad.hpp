...
#define GRAD_FIELD(X, CAT1, side, sd, S, en, cn, n) \
  X(grad_##sd##_##n, CAT1, RAW, NONE, "Top " #n "-level " en " Grad", cn "侧" #n "档梯度", cn "侧梯度(近端斜率)(降频)", R"(\frac{1}{N-1}\sum_{i=1}^{N-1}(V_{i+1,t}^{M,)" S R"(} - V_{i,t}^{M,)" S R"(}), \quad N = )" #n, OP(Grad_##side##_##n##_c1))
