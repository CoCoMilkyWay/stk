...
#define FIELDS_L1_Entropy_a_5(X, CAT1) ENTROPY_FIELD(X, CAT1, a, ask, "A", "Ask", "卖", 5)

#define NODE_Entropy_b_30(N) N(Entropy_b_30, (Entropy<30, true>), (DepthData.bid_qty), onMinute)
#define FIELDS_L1_Entropy_b_30(X, CAT1) ENTROPY_FIELD(X, CAT1, b, bid, "B", "Bid", "买", 30)

#define NODE_Entropy_b_5(N) N(Entropy_b_5, (Entropy<5, true>), (DepthData.bid_qty), onMinute)
#define FIELDS_L1_Entropy_b_5(X, CAT1) ENTROPY_FIELD(X, CAT1, b, bid, "B", "Bid", "买", 5)
