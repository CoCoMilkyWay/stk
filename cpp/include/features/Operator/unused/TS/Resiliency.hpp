...
#define FIELDS_L1_Resiliency(X, CAT1)                                                                                                                                                                                                                                                                                                     \
  X(resil_ratio_bid, CAT1, RATIO, "Bid Resiliency Ratio", "买侧韧性比", "买侧挂单量/消耗量,>1深度增长(降频)", R"(\frac{|O_W^{M,B}|}{|O_W^{T,B}|+|O_W^{C,B}|})", OP(Resiliency, resil_ratio_bid, None, None))                                                                                                                              \
  X(resil_ratio_ask, CAT1, RATIO, "Ask Resiliency Ratio", "卖侧韧性比", "卖侧挂单量/消耗量,>1深度增长(降频)", R"(\frac{|O_W^{M,A}|}{|O_W^{T,A}|+|O_W^{C,A}|})", OP(Resiliency, resil_ratio_ask, None, None))                                                                                                                              \
  X(resil_imb, CAT1, RATIO, "Resiliency Imbalance", "韧性失衡", "买卖韧性比差异(正=买侧恢复快)(降频)", R"(\frac{R^B-R^A}{R^B+R^A}, \quad R^s=\frac{|O_W^{M,s}|}{|O_W^{T,s}|+|O_W^{C,s}|})", OP(Resiliency, resil_imb, None, None))                                                                                                        \
  X(resil_dev_bid, CAT1, RAW, "Bid Depth Deviation", "买侧深度偏离", "当前深度vs移动均值偏离度(负=被冲击)(降频)", R"(\frac{D_t^B-\bar{D}_W^B}{\bar{D}_W^B}, \quad D_t^s=\sum_{i=1}^{N}V_{i,t}^{M,s}, \quad \bar{D}_W^s=\frac{1}{|W|}\sum_{\tau\in W}D_\tau^s)", OP(Resiliency, resil_dev_bid, None, None))                                \
  X(resil_dev_ask, CAT1, RAW, "Ask Depth Deviation", "卖侧深度偏离", "当前深度vs移动均值偏离度(负=被冲击)(降频)", R"(\frac{D_t^A-\bar{D}_W^A}{\bar{D}_W^A}, \quad D_t^s=\sum_{i=1}^{N}V_{i,t}^{M,s}, \quad \bar{D}_W^s=\frac{1}{|W|}\sum_{\tau\in W}D_\tau^s)", OP(Resiliency, resil_dev_ask, None, None))                                \
  X(resil_mr_bid, CAT1, RAW, "Bid Mean-Reversion Speed", "买侧均值回归速度", "深度偏离度变化率(正=恢复中)(降频)", R"(d_t^B-d_{t-1}^B, \quad d_t^s=\frac{D_t^s-\bar{D}_W^s}{\bar{D}_W^s}, \quad D_t^s=\sum_{i=1}^{N}V_{i,t}^{M,s})", OP(Resiliency, resil_mr_bid, None, None))                                                             \
  X(resil_mr_ask, CAT1, RAW, "Ask Mean-Reversion Speed", "卖侧均值回归速度", "深度偏离度变化率(正=恢复中)(降频)", R"(d_t^A-d_{t-1}^A, \quad d_t^s=\frac{D_t^s-\bar{D}_W^s}{\bar{D}_W^s}, \quad D_t^s=\sum_{i=1}^{N}V_{i,t}^{M,s})", OP(Resiliency, resil_mr_ask, None, None))                                                             \
  X(resil_recov_bid, CAT1, RAW, "Bid Recovery Signal", "买侧恢复信号", "冲击状态下的正向恢复强度(降频)", R"(\max(0,\Delta d_t^B)\cdot\mathbf{1}_{d_t^B<0}, \quad \Delta d_t^s=d_t^s-d_{t-1}^s, \quad d_t^s=\frac{D_t^s-\bar{D}_W^s}{\bar{D}_W^s}, \quad D_t^s=\sum_{i=1}^{N}V_{i,t}^{M,s})", OP(Resiliency, resil_recov_bid, None, None)) \
  X(resil_recov_ask, CAT1, RAW, "Ask Recovery Signal", "卖侧恢复信号", "冲击状态下的正向恢复强度(降频)", R"(\max(0,\Delta d_t^A)\cdot\mathbf{1}_{d_t^A<0}, \quad \Delta d_t^s=d_t^s-d_{t-1}^s, \quad d_t^s=\frac{D_t^s-\bar{D}_W^s}{\bar{D}_W^s}, \quad D_t^s=\sum_{i=1}^{N}V_{i,t}^{M,s})", OP(Resiliency, resil_recov_ask, None, None))
