...
// =============================================================================
// Flow - 分钟增量流量 + 竞价成交 (compute=onTick, flush=onMinute; feature_list.md 1.2 / 1.7)
// =============================================================================
...
//   总成交额 / 量 / 笔数 不单列: = 买 + 卖 两口按行求和 (因子层做); K 线派生见 Basic/Bar.hpp.
//   fp16 落盘: 额 / 量 / 笔 用 Log Tf; 价原值.
...
public:
  ...
  Flow(const TickData &td, const float &lim_up, const float &lim_dn) : td_(td), lim_up_(lim_up), lim_dn_(lim_dn) {}
