...
#define FIELDS_L1_Oa(X)                                                                                                                                                                                                                                                                                                                               \
  X(oa_bcr, 1, DATA, ORDER_FLOW, RATIO, NONE, "00/100/00", "OA Bid Cancel Ratio", "早盘竞价买方撤单率", "集合竞价买方撤单额占买方挂单额比例(降频)", R"(\frac{\sum_{\tau\in\mathcal{T}_{\mathrm{OA}}}|O_{\tau}^{C,B}|}{\sum_{\tau\in\mathcal{T}_{\mathrm{OA}}}|O_{\tau}^{M,B}|}, \quad \mathcal{T}_{\mathrm{OA}}=[09\!:\!15,09\!:\!25))", OP(Oa, bcr)) \
  X(oa_acr, 1, DATA, ORDER_FLOW, RATIO, NONE, "00/100/00", "OA Ask Cancel Ratio", "早盘竞价卖方撤单率", "集合竞价卖方撤单额占卖方挂单额比例(降频)", R"(\frac{\sum_{\tau\in\mathcal{T}_{\mathrm{OA}}}|O_{\tau}^{C,A}|}{\sum_{\tau\in\mathcal{T}_{\mathrm{OA}}}|O_{\tau}^{M,A}|}, \quad \mathcal{T}_{\mathrm{OA}}=[09\!:\!15,09\!:\!25))", OP(Oa, acr)) \
  X(oa_btr, 1, DATA, ORDER_FLOW, RATIO, NONE, "00/100/00", "OA Bid Trade Ratio", "早盘竞价买方成交率", "集合竞价买方成交额占买方挂单额比例(降频)", R"(\frac{\sum_{\tau\in\mathcal{T}_{\mathrm{OA}}}|O_{\tau}^{T,B}|}{\sum_{\tau\in\mathcal{T}_{\mathrm{OA}}}|O_{\tau}^{M,B}|}, \quad \mathcal{T}_{\mathrm{OA}}=[09\!:\!15,09\!:\!25))", OP(Oa, btr))  \
  X(oa_atr, 1, DATA, ORDER_FLOW, RATIO, NONE, "00/100/00", "OA Ask Trade Ratio", "早盘竞价卖方成交率", "集合竞价卖方成交额占卖方挂单额比例(降频)", R"(\frac{\sum_{\tau\in\mathcal{T}_{\mathrm{OA}}}|O_{\tau}^{T,A}|}{\sum_{\tau\in\mathcal{T}_{\mathrm{OA}}}|O_{\tau}^{M,A}|}, \quad \mathcal{T}_{\mathrm{OA}}=[09\!:\!15,09\!:\!25))", OP(Oa, atr))
