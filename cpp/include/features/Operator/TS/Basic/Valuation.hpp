...
#define FIELDS_L1_Val(X)                                                                                                                                                                         \
  X(mcap, 1, DATA, BASIC, RAW, LOG_ZSCORE, "00/010/00", "Market Cap RT", "实时总市值", "分钟最新价×总股本(亿元,不复权真市值)", R"(\frac{P_t \cdot S^{total}_{D}}{10^{8}})", OP(Val, mcap))       \
  X(fmcap, 1, DATA, BASIC, RAW, LOG_ZSCORE, "00/010/00", "Float Market Cap RT", "实时流通市值", "分钟最新价×A股流通股本(亿元)", R"(\frac{P_t \cdot S^{float}_{D}}{10^{8}})", OP(Val, fmcap))     \
  X(pe, 1, DATA, BASIC, RATIO, NONE, "00/010/00", "PE TTM RT", "实时市盈率TTM", "实时市值/归母净利TTM(亏损→负PE保留,分母0→NaN)", R"(\frac{P_t S^{total}_{D}}{NP^{TTM}_{D}})", OP(Val, pe))       \
  X(pb, 1, DATA, BASIC, RATIO, NONE, "00/010/00", "PB MRQ RT", "实时市净率MRQ", "实时市值/归母权益MRQ(负权益→负PB保留,分母0→NaN)", R"(\frac{P_t S^{total}_{D}}{EQ^{MRQ}_{D}})", OP(Val, pb))     \
  X(ps, 1, DATA, BASIC, RATIO, NONE, "00/010/00", "PS TTM RT", "实时市销率TTM", "实时市值/营业总收入TTM(营收≤0为脏值→NaN)", R"(\frac{P_t S^{total}_{D}}{REV^{TTM}_{D}})", OP(Val, ps))           \
  X(pcf, 1, DATA, BASIC, RATIO, NONE, "00/010/00", "PCF TTM RT", "实时市现率TTM", "实时市值/经营现金流TTM(烧钱→负PCF保留,分母0→NaN)", R"(\frac{P_t S^{total}_{D}}{CF^{TTM}_{D}})", OP(Val, pcf)) \
  X(limit_up, 1, DATA, BASIC, RAW, NONE, "00/010/00", "Limit Up RT", "实时涨停标记", "分钟最新价触及当日涨停价", R"(\mathbf{1}[P_t \geq P^{up}_{D} - 10^{-4}])", OP(Val, limit_up))              \
  X(limit_dn, 1, DATA, BASIC, RAW, NONE, "00/010/00", "Limit Down RT", "实时跌停标记", "分钟最新价触及当日跌停价", R"(\mathbf{1}[P_t \leq P^{dn}_{D} + 10^{-4}])", OP(Val, limit_dn))            \
  X(low_p, 1, DATA, BASIC, RAW, NONE, "00/010/00", "Low Price RT", "实时低价标记", "分钟最新价 < 1元(面值退市风险)", R"(\mathbf{1}[P_t < 1])", OP(Val, low_p))                                   \
  X(low_mc, 1, DATA, BASIC, RAW, NONE, "00/010/00", "Low Market Cap RT", "实时低市值标记", "实时市值 < 阈值(主板5亿/其他3亿)", R"(\mathbf{1}[P_t S^{total}_{D} < \theta])", OP(Val, low_mc))
