...
// =============================================================================
// TS 算子的挖掘 CPU 后端 (factor::cpu::ts, 72 个, 对应 OpTable 的 OP_TS_POINT / OP_TS_WIN)
// =============================================================================
...
// =============================================================================
// OP_TS_POINT (22): 逐点无状态, 单遍. 表达式与流式严格同式 (三后端要位级一致).
// =============================================================================
...
// =============================================================================
// OP_TS_WIN / EXPAND (23): 沿 t 递推, 段界 reset. 状态 = 跨资产数组.
// =============================================================================
...
// =============================================================================
// OP_TS_WIN / ROLL (26): 滑动加减 + van Herk 极值; 窗未满 (t < d−1) 一律无效
// =============================================================================
